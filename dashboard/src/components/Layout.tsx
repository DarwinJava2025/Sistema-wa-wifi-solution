...
const allNavItems = [
  ...
  { to: '/scheduled-messages', icon: CalendarClock, key: 'scheduledMessages' as const, adminOnly: false },
  { to: '/group-broadcasts', icon: Megaphone, key: 'groupBroadcasts' as const, adminOnly: false },
    ...
    <div className="layout">
      {isMobile && (
        <header className="mobile-header">
          ...
          <div className="mobile-brand">
            <img src="/system_wifi_menu_logo.webp" alt="System-wifi" className="mobile-logo-horizontal" />
          </div>
          <div style={{ width: 40 }} />
        </header>
      )}
      ...
      >
        <div className="sidebar-header">
          {isCollapsed ? (
            <img src="/system_wifi_icon.webp" alt="System-wifi" className="sidebar-logo collapsed-logo" />
          ) : (
            <div className="sidebar-brand-centered">
              <img src="/system_wifi_menu_logo.webp" alt="System-wifi" className="sidebar-logo-horizontal" />
