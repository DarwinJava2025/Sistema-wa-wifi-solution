...
export function createSwaggerConfig(): Omit<OpenAPIObject, 'paths'> {
  ...
  return (
    new DocumentBuilder()
      ...
      .setDescription(
        'Plataforma integral para la administración y gestión de la comunicación a través de WhatsApp en tiempo real, ' +
          'configuración avanzada para Inteligencia Artificial (IA), automatización de respuestas y flujos de trabajo, ' +
          'y monitoreo continuo de sesiones y rendimiento del sistema.',
      )
      .setVersion(version)
