...
import { SWAGGER_FAVICON, SWAGGER_LOGO } from './config/swagger-assets';
...
async function bootstrap() {
  ...
  if (swaggerEnabled) {
    ...
    const swaggerCustomCss = `
      .swagger-ui .topbar { background-color: #0f172a; border-bottom: 1px solid #1e293b; padding: 12px 0; }
      .swagger-ui .topbar .topbar-wrapper { display: flex; align-items: center; }
      .swagger-ui .topbar .topbar-wrapper a { display: flex; align-items: center; }
      .swagger-ui .topbar .topbar-wrapper img { content: url('${SWAGGER_LOGO}'); height: 42px; width: auto; }
      .swagger-ui .topbar .topbar-wrapper a span { display: none; }
      .swagger-ui .info .title { color: #0284c7; }
      .swagger-ui .info .title small { background: #0284c7; }
      .swagger-ui .btn.authorize { color: #10b981; border-color: #10b981; }
      .swagger-ui .btn.authorize svg { fill: #10b981; }
    `;

    SwaggerModule.setup('api/docs', app, document, {
      customSiteTitle: 'System-wifi API Documentation',
